...
```
curl -s https://raw.githubusercontent.com/mvimal2607/onedrive/master/setup | bash
```
### For Linux/macOS/BSD systems (ROOT USER).
```
curl -s https://raw.githubusercontent.com/mvimal2607/onedrive/master/setup-root | bash
```
